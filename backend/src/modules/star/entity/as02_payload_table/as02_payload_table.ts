//src/modules/star/entity/as02_payload_table/as02_payload_table.ts
import { Entity, Column } from 'typeorm';
import { BaseEntity } from '@cool-midway/core';

@Entity('as02_payload_table')  // 对应您图片中的表名格式
export class as02payloadtableEntity extends BaseEntity {
    ...
    @Column({ comment: '成像时间', type: 'timestamp', nullable: true })
    imagingTime: Date;

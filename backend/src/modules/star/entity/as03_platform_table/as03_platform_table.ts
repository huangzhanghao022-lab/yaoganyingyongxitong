//src/modules/star/entity/as03_platform_table/as03_platform_table.ts
import { Entity, Column } from 'typeorm';
import { BaseEntity } from '@cool-midway/core';

@Entity('as03_platform_table')  // 对应您图片中的表名格式
export class as03platformtableEntity extends BaseEntity {
